...
typedef enum {
    START,DATAIN,CRUSH,PRSLV,
    SYBOL,NUMER, CROSS,ELAPS
  } tim_set;
...
typedef enum {
    SysWarning=30,
    NOT_ROW_TYPE,NULL_ROW_SEC,DPL_ROW_NAME,DPL_COL_NAME,ZERO_ELEM,
    NOT_ROW_NAME,NOT_COL_NAME,DPL_RNG_ROW, NOT_BND_TYPE,
    ...
    EXC_NNZLIM,  SZE_ERROR,  SYB_PROC_ERR
  } errmsg;
...
typedef enum {
    ...
    ENDATA  =6,HEADCARD=10,MIDCARD =11
  } mpssec;
...
typedef enum {
    ProcOk  =0,
    OutOfSpc,ItrLimit,ProcStall,
    NumDiff, FacError,UnkError
  } procsta;
